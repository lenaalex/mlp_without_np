# -*- coding: utf-8 -*-
"""
Created on Tue Oct 30 08:04:25 2018
...
#testing for algorithms for different of amount hidden neurons

sequens_hidden=[2,5,8,12,20,50]
for i in sequens_hidden:
    print('Iteration with number og hidden neurons',i)
    net1 = mlp2.mlp2(train,train_targets,i)
    net1.earlystopping(train, train_targets, valid, valid_targets)
    net1.confusion(test,test_targets)  
